...
public class ItemControllerTest {
    ...
    private final ItemDto itemDto = new ItemDto(1L, "table", "black", true, null);
    private final BookingDto bookingDto = new BookingDto();
    private final ItemDtoByOwner itemDtoByOwner = new ItemDtoByOwner(2L, "table", "black", true, bookingDto, bookingDto,
            List.of(new CommentInfoDto()));
    private final CommentInfoDto commentDto = new CommentInfoDto(1L, "hey", "nick", 2L, LocalDateTime.now());
